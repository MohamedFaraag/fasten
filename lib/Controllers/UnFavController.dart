...
import '../Models/UnFavAdsModel.dart';

class UnFavAdsController {
  NetWork netWork = NetWork();

  UnFavAdsModel _unFavAdsModel = UnFavAdsModel();

  Future<Map<String, dynamic>> unFavads({int adid}) async {
    ...
    if (response == 'not found') {
      ...
      _unFavAdsModel = UnFavAdsModel.fromJson(response);
