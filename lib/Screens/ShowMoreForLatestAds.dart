...
class ShowMoreForLatestAds extends StatefulWidget {
  static String routeName = '/ShowMore';

  @override
  _ShowMoreForLatestAdsState createState() => _ShowMoreForLatestAdsState();
}

class _ShowMoreForLatestAdsState extends State<ShowMoreForLatestAds> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: !_isLoading
            ? RefreshIndicator(
                onRefresh: () => _getDataa(),
                child: _homeModel.data.latestAds.isEmpty
                    ? Text('NoData Now')
                    : Container(
                        ...
                        child: ListView.builder(
                            itemCount: _homeModel.data.latestAds.length,
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed(EditAds.routeName, arguments: {
                                    'id': _homeModel.data.latestAds[index].id
                                  });
                                },
                                child: Card(
